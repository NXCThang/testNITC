...
public class ATM {
	...
	View.Iterator Users = BankDatabase.createIterator();
	...
	public void authenticateuser(int pin) {
		...
		if (userAuthenticated) {
			...
			if (AdminCheck == 0) {
				...
				createAdminGUI();
			View.Iterator UserIterator = BankDatabase.createIterator();
	...
	public void IterateUser(Iterator Iterator) {
		if (Iterator.hasNext(position) == true) {
			...
			screen.messageJLabel2.setText("User name: " + AccountItem.getUsername());
